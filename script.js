...
const QUESTIONS = [
  // ======== 荣誉底蕴（6题） ========
  { id:1, question:'你更看重一支球队的什么？', category:'荣誉底蕴', options:[
    { text:'辉煌的冠军荣誉', traits:[5,1,0,0,1,0] },
    { text:'独特的踢球风格', traits:[2,0,0,0,0,5] },
    { text:'永不服输的战斗精神', traits:[1,5,0,0,1,0] },
    { text:'高效的胜利方式', traits:[3,1,0,0,0,2] }
  ]},
  { id:2, question:'对于一支球队，"传统"有多重要？', category:'荣誉底蕴', options:[
    { text:'极其重要，传统是球队的灵魂', traits:[5,0,3,0,2,0] },
    { text:'重要但需要与时俱进', traits:[3,1,1,1,1,2] },
    { text:'该打破时就要打破', traits:[1,2,0,1,0,3] },
    { text:'不太在意传统，更看当下表现', traits:[0,2,0,0,0,4] }
  ]},
  { id:3, question:'你如何看待一支球队的历史荣誉？', category:'荣誉底蕴', options:[
    { text:'荣誉是选择主队的首要标准', traits:[5,0,0,0,1,0] },
    { text:'重要但非决定性的参考', traits:[3,1,1,1,1,1] },
    { text:'历史是历史，现在才是最重要的', traits:[1,2,0,2,0,3] },
    { text:'不太重要，看对眼就行', traits:[0,3,1,0,3,2] }
  ]},
  { id:4, question:'你更喜欢哪种类型的足球故事？', category:'荣誉底蕴', options:[
    { text:'王朝崛起——统治一个时代', traits:[5,3,0,0,1,0] },
    { text:'艺术传承——一种风格的代代延续', traits:[3,1,0,2,0,5] },
    { text:'草根逆袭——小球队创造奇迹', traits:[1,4,2,0,3,0] },
    { text:'涅槃重生——低谷后重回巅峰', traits:[2,5,2,0,2,2] }
  ]},
  { id:5, question:'你如何看待足球与商业的关系？', category:'荣誉底蕴', options:[
    { text:'商业是足球发展的必然趋势', traits:[2,0,0,0,1,3] },
    { text:'足球应该保持纯粹，抵抗过度商业化', traits:[1,3,4,0,2,0] },
    { text:'找到商业和足球的平衡点', traits:[2,1,1,1,1,2] },
    { text:'不在乎，只要比赛好看就行', traits:[0,2,0,0,3,4] }
  ]},
  { id:6, question:'对于足球中的"忠诚"，你的理解是？', category:'荣誉底蕴', options:[
    { text:'一人一城是最高浪漫', traits:[3,1,5,0,2,0] },
    { text:'职业足球是生意，忠诚是奢侈品', traits:[3,0,0,0,0,2] },
    { text:'忠诚是双向的，俱乐部也要对球员忠诚', traits:[2,1,3,0,1,1] },
    { text:'只要在场上100%付出就是忠诚', traits:[1,3,0,0,1,2] }
  ]},

  // ======== 精神气质（6题） ========
  { id:7, question:'面对挑战，你通常如何应对？', category:'精神气质', options:[
    { text:'自信满满，从不怀疑自己能成功', traits:[0,5,0,0,0,1] },
    { text:'冷静分析，制定详细计划', traits:[1,0,0,2,0,2] },
    { text:'充满激情，用热血克服困难', traits:[0,5,0,0,2,1] },
    { text:'团队协作，一起寻找方案', traits:[0,2,1,0,3,1] }
  ]},
  { id:8, question:'你在团队中通常扮演什么角色？', category:'精神气质', options:[
    { text:'核心领袖，做决策的那个人', traits:[1,5,0,0,0,0] },
    { text:'创意担当，出点子的人', traits:[0,3,0,1,0,2] },
    { text:'执行者，把事情做到极致', traits:[1,2,0,0,0,2] },
    { text:'气氛组，鼓励队友的那个人', traits:[0,3,0,0,5,0] }
  ]},
  { id:9, question:'有人说你太理想主义了，你会？', category:'精神气质', options:[
    { text:'我就要坚持理想，哪怕不现实', traits:[0,5,0,1,1,0] },
    { text:'会反思，看看是否需要调整', traits:[1,1,0,2,0,1] },
    { text:'理想和现实可以兼得', traits:[1,2,0,1,0,2] },
    { text:'我不care，每个人有自己的活法', traits:[0,4,0,0,1,1] }
  ]},
  { id:10, question:'面对不喜欢的人/事，你通常？', category:'精神气质', options:[
    { text:'直接表达，不藏着掖着', traits:[0,5,0,0,0,0] },
    { text:'保持礼貌距离，不正面冲突', traits:[1,0,1,0,0,1] },
    { text:'分析是否值得我的情绪投入', traits:[1,0,0,2,0,1] },
    { text:'无视，把精力放在喜欢的事上', traits:[0,2,0,0,1,1] }
  ]},
  { id:11, question:'你对待失败的态度是？', category:'精神气质', options:[
    { text:'失败是成功之母，从中吸取经验', traits:[1,1,0,2,0,1] },
    { text:'迅速反弹，绝地反击', traits:[0,5,0,0,0,2] },
    { text:'失败很难接受，会懊悔很久', traits:[2,3,0,0,0,0] },
    { text:'不允许失败，做万全准备', traits:[2,3,0,3,0,1] }
  ]},
  { id:12, question:'如果让你定义一个成功的人生？', category:'精神气质', options:[
    { text:'站在最高处，让所有人看到', traits:[3,5,0,0,0,0] },
    { text:'安静做好每件事，被尊重', traits:[2,0,0,2,1,0] },
    { text:'影响了更多人，留下遗产', traits:[4,1,0,1,1,0] },
    { text:'每一天都过得充实快乐', traits:[0,2,1,0,3,0] }
  ]},
  ...
  { id:14, question:'你更在意哪个层面的足球？', category:'家乡归属', options:[
    { text:'顶级的——只看五大联赛和欧冠', traits:[3,1,0,0,0,2] },
    { text:'本地的——支持家乡球队最重要', traits:[0,0,5,0,2,0] },
    { text:'多元的——各国联赛都想看看', traits:[1,1,2,0,1,3] },
    { text:'随缘——好看的比赛就看', traits:[0,2,0,0,2,1] }
  ]},
  { id:15, question:'你希望足球俱乐部在社会中扮演什么角色？', category:'家乡归属', options:[
    { text:'城市名片——代表城市精神', traits:[1,1,5,0,2,0] },
    { text:'商业品牌——职业化的公司', traits:[3,0,0,0,1,2] },
    { text:'社区中心——连接邻里关系', traits:[0,1,5,0,3,0] },
    { text:'娱乐产品——提供精彩的周末节目', traits:[0,1,0,0,4,1] }
  ]},
  { id:16, question:'你对"一人一城"怎么看？', category:'家乡归属', options:[
    { text:'浪漫至死不渝，最完美足球故事', traits:[1,2,5,0,2,0] },
    { text:'敬佩但不是必需品，职业足球是生意', traits:[2,0,0,0,0,2] },
    { text:'很难得，但年轻球员应追逐更好机会', traits:[1,1,1,2,0,1] },
    { text:'无所谓，场上100%付出就够了', traits:[0,2,0,0,1,1] }
  ]},
  { id:17, question:'你如何看待中超球队？', category:'家乡归属', options:[
    { text:'家乡球队无条件支持', traits:[0,0,5,0,2,0] },
    { text:'水平有限但愿意关注进步', traits:[0,1,2,1,1,1] },
    { text:'偶尔看，主要看欧洲联赛', traits:[2,0,0,0,1,2] },
    { text:'不太关心中超', traits:[2,0,0,0,0,1] }
  ]},
  { id:18, question:'欧洲足球 vs 本地足球，你更关注？', category:'家乡归属', options:[
    { text:'欧洲顶级联赛是首选', traits:[3,0,0,0,1,3] },
    { text:'欧洲为主，但也会关注本地球队', traits:[2,0,2,0,1,2] },
    { text:'本地和中超优先，欧洲为辅', traits:[0,0,5,0,2,1] },
    { text:'只看本地的，欧洲太遥远', traits:[0,1,5,0,3,0] }
  ]},

  // ======== 青训文化（6题） ========
  { id:19, question:'一支球队应该优先投资什么？', category:'青训文化', options:[
    { text:'建设青训体系——长远发展之本', traits:[0,0,1,5,0,1] },
    { text:'引进顶级巨星——立竿见影', traits:[4,1,0,0,1,0] },
    { text:'打造战术体系——体系大于个人', traits:[1,0,0,3,0,5] },
    { text:'改造球场和训练设施——打好基础', traits:[2,0,1,3,2,0] }
  ]},
  { id:20, question:'你希望青训培养出什么类型的球员？', category:'青训文化', options:[
    { text:'全能战士，能适应多个位置', traits:[1,2,0,3,0,4] },
    { text:'专精某个位置的天才', traits:[2,2,0,1,0,2] },
    { text:'有领袖气质的队长型球员', traits:[1,4,0,1,1,0] },
    { text:'战术执行力强的体系球员', traits:[1,0,0,4,0,2] }
  ]},
  { id:21, question:'你认为一支球队良性发展的关键？', category:'青训文化', options:[
    { text:'持续的青训造血能力', traits:[0,0,1,5,0,1] },
    { text:'稳定的资金投入', traits:[3,0,0,0,0,3] },
    { text:'优秀的教练团队', traits:[1,1,0,3,0,2] },
    { text:'忠实的球迷基础', traits:[0,1,2,0,5,0] }
  ]},
  { id:22, question:'你更欣赏哪种青训模式？', category:'青训文化', options:[
    { text:'拉玛西亚式——从小培养统一风格（如巴萨）', traits:[1,0,0,5,0,2] },
    { text:'多特蒙德式——给年轻人一线队机会成名', traits:[0,2,0,4,1,1] },
    { text:'本菲卡/波尔图式——发掘璞玉高价卖出', traits:[2,0,0,4,0,2] },
    { text:'切尔西/曼城式——买半成品外租锻炼', traits:[3,0,0,2,0,2] }
  ]},
  { id:23, question:'你如何看待年轻球员的培养？', category:'青训文化', options:[
    { text:'应该给更多一线队出场时间', traits:[0,0,1,5,0,1] },
    { text:'需要外租锻炼积累经验', traits:[0,0,0,3,0,2] },
    { text:'好苗子自然会冒出来', traits:[1,2,0,1,0,1] },
    { text:'成熟球员更靠谱，年轻人太冒险', traits:[3,0,0,0,0,1] }
  ]},
  { id:24, question:'你希望球队如何对待功勋老将？', category:'青训文化', options:[
    { text:'终身合同，让传奇在此退役', traits:[1,1,4,1,3,0] },
    { text:'适时放手，给年轻人腾出空间', traits:[0,0,0,4,0,2] },
    { text:'看状态决定，不感情用事', traits:[2,0,0,2,0,1] },
    { text:'可以离队但保留俱乐部大使等角色', traits:[2,1,1,2,1,1] }
  ]},

  // ======== 球迷文化（6题） ========
  { id:25, question:'比赛日现场，哪个感官体验最打动你？', category:'球迷文化', options:[
    { text:'万人齐声高歌的声浪淹没一切', traits:[0,2,0,0,5,0] },
    { text:'宏伟建筑本身带来的压迫与敬畏', traits:[3,1,0,0,1,1] },
    { text:'tifo缓缓升起时屏息的视觉震撼', traits:[0,1,0,0,5,0] },
    { text:'精密战术从看台俯瞰如棋局展开', traits:[0,0,0,1,0,5] }
  ]},
  { id:26, question:'足球比赛中，哪个声音最让你兴奋？', category:'球迷文化', options:[
    { text:'球迷全场高歌的声浪', traits:[0,1,0,0,5,0] },
    { text:'球击中门框的"砰"', traits:[0,3,0,0,1,1] },
    { text:'解说员激情喊出的"Gooal!"', traits:[0,3,0,0,2,0] },
    { text:'裁判终场哨响那一刻的寂静', traits:[1,1,0,0,1,0] }
  ]},
  { id:27, question:'你最喜欢哪种赛前仪式？', category:'球迷文化', options:[
    { text:'巨型tifo缓缓展开', traits:[0,2,0,0,5,0] },
    { text:'全场齐唱队歌', traits:[0,1,1,0,5,0] },
    { text:'队长带领全队击掌', traits:[0,3,0,0,1,0] },
    { text:'安静的一分钟默哀', traits:[1,0,1,0,1,0] }
  ]},
  { id:28, question:'你最喜欢哪种赛前氛围？', category:'球迷文化', options:[
    { text:'球场周围的街头小吃和球迷聚会', traits:[0,1,2,0,5,0] },
    { text:'精心制作的球队主题Vlog/纪录片', traits:[1,1,0,2,2,0] },
    { text:'社交媒体上的赛前热议和预测', traits:[0,2,0,0,3,0] },
    { text:'安静地读赛前战术分析文章', traits:[1,0,0,2,0,3] }
  ]},
  { id:29, question:'足球比赛的音乐，你喜欢什么风格？', category:'球迷文化', options:[
    { text:'恢弘的管弦乐与万人合唱——庄严感', traits:[1,1,0,0,5,0] },
    { text:'摇滚/重金属式（Seven Nation Army）', traits:[0,4,0,0,4,0] },
    { text:'拉丁/桑巴鼓点', traits:[0,3,1,0,4,0] },
    { text:'电子/现代节奏', traits:[0,2,0,0,2,2] }
  ]},
  { id:30, question:'比赛日你会怎么过？', category:'球迷文化', options:[
    { text:'提前两小时进场感受热身与氛围', traits:[0,1,0,0,5,0] },
    { text:'和球友在酒吧边喝边看', traits:[0,2,0,0,4,0] },
    { text:'在家准备好零食饮料一个人专注', traits:[0,0,0,0,1,0] },
    { text:'打开多个屏幕一边看数据一边看球', traits:[0,0,0,3,0,3] }
  ]},

  // ======== 战术风格（6题） ========
  { id:31, question:'你认为足球战术中最迷人的是？', category:'战术风格', options:[
    { text:'高位压迫与快速反击', traits:[0,3,0,0,0,5] },
    { text:'精密的传控与位置轮转', traits:[1,0,0,2,0,5] },
    { text:'链式防守与区域联防', traits:[2,1,0,0,0,3] },
    { text:'个人能力与战术自由', traits:[0,4,0,0,0,2] }
  ]},
  { id:32, question:'一场比赛中最让你着迷的瞬间是？', category:'战术风格', options:[
    { text:'精妙的团队配合后破门', traits:[0,1,0,1,0,5] },
    { text:'个人能力的华丽展现', traits:[0,4,0,0,1,2] },
    { text:'绝境中的绝杀逆转', traits:[0,5,0,0,2,0] },
    { text:'一次完美的战术防守', traits:[1,1,0,0,0,3] }
  ]},
  { id:33, question:'最后5分钟1-0领先，你希望球队？', category:'战术风格', options:[
    { text:'继续进攻，再进一球杀死比赛', traits:[0,4,0,0,0,3] },
    { text:'控球消耗时间，安全第一', traits:[2,0,0,0,0,2] },
    { text:'全员回防，守住胜利', traits:[1,1,0,0,0,1] },
    { text:'保持原有节奏，不刻意改变', traits:[1,1,0,0,0,2] }
  ]},
  { id:34, question:'你更欣赏哪种竞技哲学？', category:'战术风格', options:[
    { text:'高强度快节奏，每一秒都让人窒息', traits:[0,4,0,0,2,4] },
    { text:'技术创造力至上，美感是最高标准', traits:[1,1,0,1,1,5] },
    { text:'激情与青春风暴，永远不知疲倦', traits:[0,4,0,2,1,2] },
    { text:'战术纪律严明，防守本身就是艺术', traits:[2,1,0,0,0,3] }
  ]},
  { id:35, question:'你更喜欢哪种球队的战术标签？', category:'战术风格', options:[
    { text:'"传控足球"——耐心控球寻找杀机', traits:[1,0,0,0,0,5] },
    { text:'"重金属足球"——高速转换与压迫', traits:[0,4,0,0,1,4] },
    { text:'"铁血防守"——固若金汤不丢球', traits:[2,1,0,0,0,2] },
    { text:'"反击足球"——快速致命一击', traits:[1,2,0,0,1,3] }
  ]},
  { id:36, question:'你看足球比赛最关注哪个环节？', category:'战术风格', options:[
    { text:'进攻组织——如何创造得分机会', traits:[0,1,0,0,0,5] },
    { text:'防守布阵——如何限制对手', traits:[1,0,0,0,0,3] },
    { text:'中场绞杀——谁能控制中场', traits:[0,3,0,0,0,4] },
    { text:'换人调整——教练的后手招', traits:[0,1,0,3,0,2] }
  ]},
];
...
const HOMETOWN_BONUS = 0.008; // 家乡匹配加权 0.8%（ZJU受众面向上调）
...
const POPULARITY_BONUS = {
  ...
  inter_milan:0.001, zhejiang:0.003, tottenham:0.001,
};
