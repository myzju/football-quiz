...
const QUESTIONS = [
  ...
  { id:2, question:'你如何看待"赢球就是一切"？', category:'荣誉底蕴', options:[
    { text:'完全同意，冠军说明一切', traits:[5,2,0,0,0,0] },
    { text:'赢球重要，但踢得好看也重要', traits:[2,0,0,0,0,4] },
    { text:'过程比结果更值得尊重', traits:[1,3,0,0,0,2] },
    { text:'选择最聪明的方式去赢', traits:[2,0,0,0,0,3] }
  ]},
  { id:3, question:'对于一支球队，"传统"有多重要？', category:'荣誉底蕴', options:[
  ...
  { id:4, question:'你如何看待一支球队的历史荣誉？', category:'荣誉底蕴', options:[
  ...
  { id:5, question:'一支球队最不能丢失的品质是什么？', category:'荣誉底蕴', options:[
    { text:'求胜欲——永远渴望胜利', traits:[3,5,0,0,0,1] },
    { text:'忠诚——球员和球迷的彼此承诺', traits:[2,1,4,0,3,0] },
    { text:'传承——一代代人对足球的理解', traits:[5,1,2,2,1,1] },
    { text:'创新——不断突破战术边界', traits:[1,2,0,3,0,5] }
  ]},
  { id:6, question:'如果主队连续多年无冠，你会？', category:'荣誉底蕴', options:[
    { text:'一直支持，低谷更显忠诚', traits:[1,3,3,0,4,0] },
    { text:'理解，但期待俱乐部做出改变', traits:[2,1,1,2,1,2] },
    { text:'有点失望，可能会少看一些比赛', traits:[3,0,0,0,1,1] },
    { text:'很难接受，胜利才是硬道理', traits:[5,1,0,0,0,0] }
  ]},
  { id:7, question:'你更喜欢哪种类型的足球故事？', category:'荣誉底蕴', options:[
  ...
  { id:8, question:'足球的终极意义是什么？', category:'荣誉底蕴', options:[
    { text:'带给人们快乐与激情', traits:[0,2,1,0,5,1] },
    { text:'创造永恒的历史与传奇', traits:[5,2,0,1,1,1] },
    { text:'连接不同文化与人群', traits:[1,1,3,0,3,0] },
    { text:'诠释团队合作的最高境界', traits:[1,3,1,0,1,3] }
  ]},
  { id:9, question:'你认为足球俱乐部最重要的是对谁负责？', category:'荣誉底蕴', options:[
    { text:'球迷——他们是俱乐部的灵魂', traits:[1,1,2,0,5,0] },
    { text:'投资人——有资金才能发展', traits:[3,0,0,0,1,2] },
    { text:'社区——俱乐部属于所在城市', traits:[1,0,5,0,2,0] },
    { text:'球员——他们才是场上主角', traits:[1,2,0,1,0,3] }
  ]},
  { id:10, question:'你更喜欢哪种类型的教练？', category:'荣誉底蕴', options:[
    { text:'战术大师，每一脚传球都有设计', traits:[2,0,0,1,0,5] },
    { text:'激情领袖，用情绪感染全队', traits:[0,5,0,0,2,1] },
    { text:'纪律严明，军队式管理', traits:[4,2,0,0,1,2] },
    { text:'善于沟通，像朋友一样的导师', traits:[1,1,0,3,2,1] }
  ]},
  { id:11, question:'你对"All or Nothing"的态度？', category:'荣誉底蕴', options:[
    { text:'当然！不成功便成仁', traits:[2,5,0,0,0,2] },
    { text:'稳定压倒一切，拒绝极端', traits:[3,0,1,2,0,1] },
    { text:'具体情况具体分析', traits:[1,1,1,2,0,2] },
    { text:'过程比结果重要，尽力就好', traits:[0,2,0,1,3,1] }
  ]},
  { id:12, question:'你如何看待足球与商业的关系？', category:'荣誉底蕴', options:[
  ...
  { id:13, question:'一支球队应该优先投资什么？', category:'荣誉底蕴', options:[
    { text:'引进顶级巨星', traits:[4,1,0,0,1,0] },
    { text:'建设青训体系', traits:[1,0,1,5,0,1] },
    { text:'打造战术体系', traits:[1,0,0,2,0,5] },
    { text:'改造球场和训练设施', traits:[1,0,1,2,2,1] }
  ]},
  { id:14, question:'对于足球中的"忠诚"，你的理解是？', category:'荣誉底蕴', options:[
  ...
  { id:15, question:'足球对你来说最重要的是什么？', category:'荣誉底蕴', options:[
    { text:'精彩的进球与进攻', traits:[0,2,0,0,3,4] },
    { text:'坚固的防守与战术纪律', traits:[2,1,0,0,0,3] },
    { text:'球星个人的光芒', traits:[3,2,0,0,1,1] },
    { text:'团队配合的默契', traits:[1,2,1,0,1,4] }
  ]},
  { id:16, question:'你更认同哪种足球哲学？', category:'荣誉底蕴', options:[
    { text:'全攻全守——整体大于个人', traits:[2,3,0,1,0,5] },
    { text:'实用主义——赢球才是硬道理', traits:[5,0,0,0,0,1] },
    { text:'技术流——用脚下技术说话', traits:[2,1,0,2,0,5] },
    { text:'高压逼抢——用奔跑弥补差距', traits:[1,4,0,1,1,4] }
  ]},
  { id:17, question:'你希望球队在场上展现出什么样的气质？', category:'荣誉底蕴', options:[
    { text:'王者之气——对手还没踢就害怕', traits:[5,3,0,0,0,0] },
    { text:'艺术家风范——每一脚都是享受', traits:[2,0,0,0,1,5] },
    { text:'斗士精神——只要还有一口气就拼', traits:[1,5,0,0,2,2] },
    { text:'智将风采——用战术智慧取胜', traits:[2,1,0,2,0,5] }
  ]},

  // ======== 精神气质（17题） ========
  { id:18, question:'面对挑战，你通常如何应对？', category:'精神气质', options:[
  ...
  { id:19, question:'你在团队中通常扮演什么角色？', category:'精神气质', options:[
  ...
  { id:20, question:'你更倾向于哪种做事风格？', category:'精神气质', options:[
    { text:'激进大胆，敢于冒险', traits:[1,5,0,0,0,2] },
    { text:'稳健保守，步步为营', traits:[3,0,1,1,0,0] },
    { text:'灵活应变，随情况调整', traits:[0,2,1,2,0,3] },
    { text:'追求完美，每个细节都重要', traits:[2,1,0,3,0,2] }
  ]},
  { id:21, question:'你的朋友圈子是什么样的？', category:'精神气质', options:[
    { text:'几个知心老友，友谊长年不变', traits:[1,1,4,0,1,0] },
    { text:'圈子很广，认识各行各业的人', traits:[0,4,0,0,3,0] },
    { text:'精简高效，只跟对的人深交', traits:[2,2,0,0,0,1] },
    { text:'志同道合的小团体', traits:[0,2,2,0,3,0] }
  ]},
  { id:22, question:'有人说你太理想主义了，你会？', category:'精神气质', options:[
  ...
  { id:23, question:'面对不喜欢的人/事，你通常？', category:'精神气质', options:[
  ...
  { id:24, question:'你的消费习惯更接近哪种？', category:'精神气质', options:[
    { text:'喜欢就买，享受当下', traits:[0,4,0,0,2,0] },
    { text:'精打细算，长期规划', traits:[2,0,1,2,0,0] },
    { text:'注重品质，少而精', traits:[3,1,0,0,1,1] },
    { text:'为体验和经历花钱', traits:[0,2,0,0,3,1] }
  ]},
  { id:25, question:'旅行时你更喜欢？', category:'精神气质', options:[
    { text:'精心规划每个景点和餐厅', traits:[1,0,0,2,0,0] },
    { text:'到了再说，随心所欲探索', traits:[0,4,0,0,1,1] },
    { text:'只定大方向，享受意外惊喜', traits:[0,3,0,1,1,1] },
    { text:'跟着当地人/朋友走', traits:[0,1,3,0,3,0] }
  ]},
  { id:26, question:'工作/学习中，你的动力来源？', category:'精神气质', options:[
    { text:'想让所有人看到我的能力', traits:[1,5,0,0,0,0] },
    { text:'想把事情做到完美', traits:[2,1,0,3,0,1] },
    { text:'享受和团队一起完成目标的成就感', traits:[0,2,0,0,3,1] },
    { text:'想要创造不一样的东西', traits:[0,4,0,2,0,2] }
  ]},
  { id:27, question:'你对"改变"的态度？', category:'精神气质', options:[
    { text:'拥抱变化，不变才无聊', traits:[0,5,0,1,0,2] },
    { text:'谨慎接受，需要看到充分理由', traits:[2,0,0,2,0,1] },
    { text:'喜欢改变带来的新鲜感', traits:[0,4,0,0,1,1] },
    { text:'保持现状挺好的，不喜欢折腾', traits:[3,0,1,0,0,0] }
  ]},
  { id:28, question:'你更喜欢哪种领导风格？', category:'精神气质', options:[
    { text:'魅力型——用个人魅力感召', traits:[0,5,0,0,1,0] },
    { text:'民主型——听取每个人意见', traits:[0,1,1,0,3,0] },
    { text:'技术型——自己先做到最好', traits:[1,2,0,3,0,1] },
    { text:'无为型——相信团队自己会做好', traits:[0,1,0,1,1,0] }
  ]},
  { id:29, question:'你对待失败的态度是？', category:'精神气质', options:[
  ...
  { id:30, question:'如果让你定义一个成功的人生？', category:'精神气质', options:[
  ...
  { id:31, question:'在社交媒体上的风格？', category:'精神气质', options:[
    { text:'乐于分享生活，喜欢互动', traits:[0,3,0,0,4,0] },
    { text:'只看不发，潜水型', traits:[1,0,0,1,0,0] },
    { text:'只在专业领域发声', traits:[1,1,0,3,0,0] },
    { text:'偶尔发点有质感的内容', traits:[2,1,0,0,1,1] }
  ]},
  { id:32, question:'你是否在意别人对你的看法？', category:'精神气质', options:[
    { text:'非常在意，希望得到认可', traits:[0,2,0,0,2,0] },
    { text:'不太在意，做自己的事最重要', traits:[0,4,0,0,0,1] },
    { text:'参考但不被其左右', traits:[1,1,0,2,0,1] },
    { text:'分情况，重要的事会关注口碑', traits:[1,1,0,1,1,1] }
  ]},
  { id:33, question:'你更看重关系中的什么？', category:'精神气质', options:[
    { text:'忠诚——无论发生什么都站在一起', traits:[1,3,4,0,1,0] },
    { text:'尊重——给彼此空间和信任', traits:[1,0,1,0,1,0] },
    { text:'成长——一起变得更好', traits:[0,2,0,3,0,1] },
    { text:'快乐——在一起开心最重要', traits:[0,2,0,0,4,0] }
  ]},
  { id:34, question:'你更喜欢怎样度过周末？', category:'精神气质', options:[
    { text:'和一群朋友狂欢派对', traits:[0,4,0,0,5,0] },
    { text:'安静地做自己喜欢的事', traits:[1,0,0,1,0,0] },
    { text:'规划好每件事，高效利用时间', traits:[2,1,0,2,0,0] },
    { text:'随性而为，没有固定计划', traits:[0,3,0,0,1,1] }
  ]},

  // ======== 家乡归属（16题） ========
  { id:35, question:'你的家乡在哪个省份？', category:'家乡归属', type:'fill',
    placeholder:'例如：浙江、广东、北京…',
    note:'（用于匹配本地球队，不参与性格评分）' },
  { id:36, question:'你更在意哪个层面的足球？', category:'家乡归属', options:[
  ...
  { id:37, question:'你希望足球俱乐部在社会中扮演什么角色？', category:'家乡归属', options:[
  ...
  { id:38, question:'选择定居的城市，你最看重什么？', category:'家乡归属', options:[
    { text:'阳光充沛、热情外向的社交氛围', traits:[0,3,1,0,4,0] },
    { text:'艺术自由、处处有灵感的街区生活', traits:[1,2,1,0,2,1] },
    { text:'多元包容、24小时不打烊的活力', traits:[0,2,0,0,3,1] },
    { text:'井然有序、安静而有质感的日子', traits:[2,0,2,1,1,0] }
  ]},
  { id:39, question:'你希望球队的主场氛围是怎样的？', category:'家乡归属', options:[
    { text:'山呼海啸90分钟高歌', traits:[0,3,2,0,5,0] },
    { text:'优雅高贵的观赛体验', traits:[3,0,0,0,1,1] },
    { text:'tifo文化与视觉盛宴', traits:[0,2,1,0,5,0] },
    { text:'专业冷静的战术欣赏氛围', traits:[1,0,0,0,0,5] }
  ]},
  { id:40, question:'你对"一人一城"怎么看？', category:'家乡归属', options:[
  ...
  { id:41, question:'你如何看待足球与本地社区的关系？', category:'家乡归属', options:[
    { text:'足球是社区的纽带，密不可分', traits:[1,1,5,0,4,0] },
    { text:'职业俱乐部应该有社区责任', traits:[1,0,3,1,1,0] },
    { text:'社区足球是根基但不必过度强调', traits:[2,0,1,1,0,1] },
    { text:'我不太关心这个层面', traits:[2,0,0,0,1,2] }
  ]},
  { id:42, question:'旅行到一个新城市，你最可能做什么？', category:'家乡归属', options:[
    { text:'去当地著名球场打卡', traits:[1,1,1,0,3,0] },
    { text:'在街边看当地人踢野球感受足球文化', traits:[0,1,2,0,3,0] },
    { text:'买一件当地球队的球衣做纪念', traits:[1,0,2,0,2,1] },
    { text:'只逛景点，足球随缘', traits:[1,0,0,0,0,1] }
  ]},
  { id:43, question:'你更喜欢哪种足球社交方式？', category:'家乡归属', options:[
    { text:'加入球迷会，线下一起看球', traits:[0,1,3,0,5,0] },
    { text:'线上群聊，实时讨论比赛', traits:[0,1,0,0,2,1] },
    { text:'写球评/做视频，表达自己观点', traits:[0,2,0,0,1,2] },
    { text:'一个人看球就很享受', traits:[0,0,0,1,0,1] }
  ]},
  { id:44, question:'足球和生活中其他爱好冲突时？', category:'家乡归属', options:[
    { text:'足球优先——比赛日雷打不动', traits:[0,3,0,0,5,0] },
    { text:'看情况——重要比赛优先', traits:[0,1,0,0,2,1] },
    { text:'足球往后排——生活更重要', traits:[0,0,0,1,0,1] },
    { text:'两者兼顾——带着朋友一起看球', traits:[0,1,1,0,4,0] }
  ]},
  { id:45, question:'你如何看待中超球队？', category:'家乡归属', options:[
  ...
  { id:46, question:'你更愿意为足球花在哪？', category:'家乡归属', options:[
    { text:'球票——现场的体验无可替代', traits:[0,2,1,0,5,0] },
    { text:'会员/转播——全年无死角看球', traits:[1,0,0,0,3,1] },
    { text:'周边/球衣——穿在身上才有归属感', traits:[1,1,2,0,3,0] },
    { text:'不花钱——免费看球也很开心', traits:[0,1,0,0,1,0] }
  ]},
  { id:47, question:'你觉得足球在生活中最像什么？', category:'家乡归属', options:[
    { text:'像宗教——每周的仪式和信仰', traits:[0,3,1,0,5,0] },
    { text:'像连续剧——永远有下一集的故事', traits:[1,2,0,0,2,1] },
    { text:'像下棋——智慧的博弈', traits:[1,0,0,2,0,4] },
    { text:'像派对——和朋友们一起开心', traits:[0,2,0,0,5,0] }
  ]},
  { id:48, question:'欧洲足球 vs 本地足球，你更关注？', category:'家乡归属', options:[
  ...
  { id:49, question:'你对足球中"金元足球"的看法？', category:'家乡归属', options:[
    { text:'这就是现代足球，有钱才能竞争', traits:[3,0,0,0,0,3] },
    { text:'不喜欢但理解，没钱确实难出成绩', traits:[2,0,1,1,0,1] },
    { text:'反感，足球应该靠青训和战术', traits:[0,2,2,4,0,1] },
    { text:'中立，好坏取决于怎么花', traits:[2,1,0,1,1,2] }
  ]},
  { id:50, question:'你的足球"生物钟"是怎样的？', category:'家乡归属', options:[
    { text:'严格按照赛历生活，转会窗也不放过', traits:[2,3,0,0,2,1] },
    { text:'赛季中关注，休赛期就不怎么看了', traits:[1,1,0,0,1,1] },
    { text:'大赛型——世界杯欧洲杯必看', traits:[1,2,0,0,4,1] },
    { text:'想起来了就看，很随缘', traits:[0,0,0,0,1,0] }
  ]},

  // ======== 青训文化（16题） ========
  { id:51, question:'一支球队应该优先投资什么？', category:'青训文化', options:[
  ...
  { id:52, question:'你希望青训培养出什么类型的球员？', category:'青训文化', options:[
  ...
  { id:53, question:'你对足球数据分析的态度？', category:'青训文化', options:[
    { text:'非常认可，数据能揭示隐藏价值', traits:[0,0,0,4,0,3] },
    { text:'参考但不依赖，足球还是靠直觉', traits:[1,2,0,0,1,1] },
    { text:'不太信任数据，足球太复杂无法量化', traits:[1,2,0,1,1,0] },
    { text:'数据和主观判断各半', traits:[1,1,0,2,0,1] }
  ]},
  { id:54, question:'你认为现代足球最重要的位置是？', category:'青训文化', options:[
    { text:'中场——掌控节奏的大脑', traits:[1,0,0,2,0,5] },
    { text:'前锋——终结比赛的人', traits:[2,3,0,0,1,1] },
    { text:'后卫——冠军靠防守', traits:[3,1,0,0,0,2] },
    { text:'门将——最后一道防线', traits:[2,1,0,0,1,1] }
  ]},
  { id:55, question:'你更喜欢哪种足球游戏？', category:'青训文化', options:[
    { text:'FIFA/FC——操作真实球员', traits:[0,2,0,0,1,1] },
    { text:'Football Manager——当教练管理球队', traits:[0,0,0,4,0,3] },
    { text:'实况/Fantasy——组建梦幻阵容', traits:[1,1,0,0,1,2] },
    { text:'不玩游戏，只看真实比赛', traits:[1,1,0,0,2,0] }
  ]},
  { id:56, question:'你的足球信息获取渠道？', category:'青训文化', options:[
    { text:'懂球帝/直播吧等专业App', traits:[0,1,0,2,0,1] },
    { text:'微博/抖音/Twitter社交媒体', traits:[0,2,0,0,3,0] },
    { text:'Reddit/虎扑论坛深度讨论', traits:[0,1,0,3,1,1] },
    { text:'电视直播/集锦节目', traits:[0,1,0,0,2,0] }
  ]},
  { id:57, question:'你认为一支球队良性发展的关键？', category:'青训文化', options:[
  ...
  { id:58, question:'你更欣赏哪种青训模式？', category:'青训文化', options:[
  ...
  { id:59, question:'你对VAR（视频助理裁判）的态度？', category:'青训文化', options:[
    { text:'支持——公平比流畅更重要', traits:[1,0,0,3,0,1] },
    { text:'反对——破坏了足球的激情与流畅', traits:[0,3,0,0,2,0] },
    { text:'中立——有总比没有好，但需要改进', traits:[1,1,0,2,0,1] },
    { text:'无所谓——判罚本来就是足球的一部分', traits:[0,1,0,0,1,0] }
  ]},
  { id:60, question:'你如何看待年轻球员的培养？', category:'青训文化', options:[
  ...
  { id:61, question:'你更喜欢哪种俱乐部运营模式？', category:'青训文化', options:[
    { text:'会员制——球迷共同拥有俱乐部（如皇马巴萨）', traits:[1,1,3,1,4,0] },
    { text:'企业投资——资本驱动快速发展（如曼城巴黎）', traits:[4,0,0,0,1,2] },
    { text:'50+1模式——会员掌控多数股份（德国模式）', traits:[0,0,2,2,3,0] },
    { text:'不关心模式，看成绩说话', traits:[3,0,0,0,0,2] }
  ]},
  { id:62, question:'你希望球队在转会市场扮演什么角色？', category:'青训文化', options:[
    { text:'买家——引进强援补强', traits:[4,1,0,0,0,1] },
    { text:'卖家——培养年轻球员再高价出售', traits:[0,0,0,5,0,2] },
    { text:'自给自足——用青训填充一线队', traits:[1,0,1,5,1,0] },
    { text:'灵活应对——根据不同位置分别决策', traits:[1,1,0,2,0,1] }
  ]},
  { id:63, question:'你看足球时最容易因为什么而情绪激动？', category:'青训文化', options:[
    { text:'绝杀球——最后一秒的疯狂', traits:[0,5,0,0,3,0] },
    { text:'一次精妙绝伦的团队配合', traits:[0,1,0,1,0,5] },
    { text:'不公正的判罚', traits:[1,3,0,0,1,0] },
    { text:'球迷的歌声与tifo', traits:[0,1,0,0,5,0] }
  ]},
  { id:64, question:'你希望球队如何对待功勋老将？', category:'青训文化', options:[
  ...
  { id:65, question:'你更欣赏哪种足球技术？', category:'青训文化', options:[
    { text:'盘带过人——个人能力的绽放', traits:[0,4,0,0,1,2] },
    { text:'长传转移——大局观的展现', traits:[1,1,0,1,0,4] },
    { text:'抢断拦截——防守的艺术', traits:[1,3,0,0,0,2] },
    { text:'跑位接应——无球者的智慧', traits:[0,0,0,2,0,3] }
  ]},
  { id:66, question:'最能打动你的足球故事是？', category:'青训文化', options:[
    { text:'王朝崛起——统治一个时代', traits:[5,2,0,0,1,0] },
    { text:'涅槃重生——低谷后重回巅峰', traits:[2,4,0,0,2,1] },
    { text:'草根逆袭——小球队创造奇迹', traits:[1,4,2,0,3,0] },
    { text:'艺术传承——风格代代延续', traits:[2,0,0,3,1,4] }
  ]},

  // ======== 球迷文化（17题） ========
  { id:67, question:'你理想的足球比赛节奏是什么样的？', category:'球迷文化', options:[
    { text:'快节奏高对抗，攻防瞬息万变', traits:[0,4,0,0,3,3] },
    { text:'慢条斯理的传控，层层推进', traits:[1,0,0,0,1,5] },
    { text:'稳扎稳打，不急于进攻', traits:[3,0,0,0,0,1] },
    { text:'攻守平衡，张弛有度', traits:[1,1,0,0,1,3] }
  ]},
  { id:68, question:'比赛日现场，哪个感官体验最打动你？', category:'球迷文化', options:[
  ...
  { id:69, question:'足球比赛中，哪个声音最让你兴奋？', category:'球迷文化', options:[
  ...
  { id:70, question:'你最喜欢哪种赛前仪式？', category:'球迷文化', options:[
  ...
  { id:71, question:'你会因为什么而关注一支不熟悉的球队？', category:'球迷文化', options:[
    { text:'朋友或家人喜欢同一支球队', traits:[0,0,2,0,4,0] },
    { text:'某个球星转会到该队', traits:[2,2,0,0,1,1] },
    { text:'看了该队一场精彩的比赛', traits:[0,1,0,0,1,4] },
    { text:'了解该队的历史文化后产生认同', traits:[3,1,2,1,2,0] }
  ]},
  { id:72, question:'如果你去欧洲旅游，足球行程是？', category:'球迷文化', options:[
    { text:'必须去看一场现场比赛', traits:[0,2,0,0,5,0] },
    { text:'参观豪门球场+博物馆tour', traits:[3,0,0,0,2,0] },
    { text:'顺便逛逛球迷商店买点纪念品', traits:[1,0,0,0,3,0] },
    { text:'看情况，不刻意安排但遇到会体验', traits:[0,1,0,0,1,1] }
  ]},
  { id:73, question:'一支不被看好的弱队逆袭豪门，你的感受是？', category:'球迷文化', options:[
    { text:'热泪盈眶，这就是足球的魅力！', traits:[0,4,0,0,4,0] },
    { text:'很感动，但强队赢才是常态', traits:[3,1,0,0,0,1] },
    { text:'分析一下弱队用了什么战术', traits:[0,0,0,2,0,4] },
    { text:'关注社交媒体的讨论热度', traits:[0,2,0,0,3,0] }
  ]},
  { id:74, question:'你更喜欢在社交媒体上关注哪种足球内容？', category:'球迷文化', options:[
    { text:'球星个人生活与时尚', traits:[1,2,0,0,2,0] },
    { text:'战术分析与深度文章', traits:[1,0,0,3,0,3] },
    { text:'球迷文化与现场氛围', traits:[0,1,0,0,5,0] },
    { text:'搞笑足球段子与memes', traits:[0,2,0,0,3,0] }
  ]},
  { id:75, question:'一支球队的视觉形象，你更看重？', category:'球迷文化', options:[
    { text:'球衣设计是否时尚好看', traits:[1,1,0,0,2,1] },
    { text:'队徽是否经典有辨识度', traits:[3,0,1,0,1,0] },
    { text:'球员的精神面貌与气质', traits:[0,4,0,0,1,0] },
    { text:'球迷文化的可视化表达', traits:[0,1,0,0,5,0] }
  ]},
  { id:76, question:'你心目中足球场上最美丽的事物？', category:'球迷文化', options:[
    { text:'一脚撕裂防线的直塞球', traits:[0,1,0,0,0,5] },
    { text:'一次完美的滑铲', traits:[0,3,0,0,0,2] },
    { text:'一个不可思议的扑救', traits:[0,3,0,0,1,1] },
    { text:'队友间心领神会的配合', traits:[0,1,0,1,0,4] }
  ]},
  { id:77, question:'你更偏爱哪种阵型美学？', category:'球迷文化', options:[
    { text:'4-3-3——经典进攻宽度', traits:[0,1,0,0,1,4] },
    { text:'3-4-3——激进全攻全守', traits:[0,3,0,0,2,5] },
    { text:'4-4-2——朴实无华的双前锋', traits:[3,1,0,0,1,1] },
    { text:'3-5-2——意式战术美感', traits:[1,0,0,0,0,4] }
  ]},
  { id:78, question:'你最喜欢哪种赛前氛围？', category:'球迷文化', options:[
  ...
  { id:79, question:'你最喜欢的足球装备/周边类型？', category:'球迷文化', options:[
    { text:'本赛季最新球衣', traits:[1,2,0,0,3,0] },
    { text:'经典复古球衣', traits:[3,1,0,0,1,0] },
    { text:'围巾——球迷身份证', traits:[0,1,1,0,5,0] },
    { text:'球场模型/徽章收藏', traits:[2,0,1,0,2,0] }
  ]},
  { id:80, question:'足球比赛的音乐，你喜欢什么风格？', category:'球迷文化', options:[
  ...
  { id:81, question:'你更喜欢哪种足球纪录片风格？', category:'球迷文化', options:[
    { text:'战术复盘——深度分析比赛', traits:[0,0,0,3,0,4] },
    { text:'逆袭故事——小人物的伟大', traits:[0,4,0,0,2,0] },
    { text:'王朝记录——豪门的辉煌', traits:[5,2,0,0,1,0] },
    { text:'球迷文化——看台上的故事', traits:[0,1,0,0,5,0] }
  ]},
  { id:82, question:'一张足球海报，哪种风格最吸引你？', category:'球迷文化', options:[
    { text:'极简黑白——干净利落、留白有力', traits:[2,0,0,0,1,1] },
    { text:'复古手绘——斑驳质感、故事感', traits:[3,1,1,0,2,0] },
    { text:'大胆撞色——视觉冲击、过目不忘', traits:[0,4,0,0,3,1] },
    { text:'几何构成——秩序感、现代设计', traits:[1,0,0,2,0,2] }
  ]},
  { id:83, question:'比赛日你会怎么过？', category:'球迷文化', options:[
  ...
  // ======== 战术风格（17题） ========
  { id:84, question:'你认为足球战术中最迷人的是？', category:'战术风格', options:[
  ...
  { id:85, question:'你最喜欢看哪种类型球员的比赛？', category:'战术风格', options:[
    { text:'全能型中场，掌控全局', traits:[1,1,0,1,0,5] },
    { text:'速度型边锋，撕裂防线', traits:[0,4,0,0,1,3] },
    { text:'铁血后卫，一夫当关', traits:[1,4,0,0,0,1] },
    { text:'天才前锋，一锤定音', traits:[2,4,0,0,1,0] }
  ]},
  { id:86, question:'一场比赛中最让你着迷的瞬间是？', category:'战术风格', options:[
  ...
  { id:87, question:'一个进球最重要的是什么？', category:'战术风格', options:[
    { text:'整体的配合过程是否流畅', traits:[0,0,0,1,0,5] },
    { text:'进球的时机是否关键', traits:[1,3,0,0,1,1] },
    { text:'射门本身的技术含金量', traits:[1,2,0,0,0,3] },
    { text:'进球后的庆祝是否感染人', traits:[0,3,0,0,5,0] }
  ]},
  { id:88, question:'你更喜欢哪种比赛时间？', category:'战术风格', options:[
    { text:'周末下午——阳光下的悠闲', traits:[0,1,0,0,3,0] },
    { text:'周六晚间黄金档——最好的留给足球', traits:[0,2,0,0,4,0] },
    { text:'欧冠周中夜——与全欧洲同步', traits:[2,2,0,0,2,1] },
    { text:'深夜——只有我和屏幕里的足球', traits:[0,0,0,0,1,0] }
  ]},
  { id:89, question:'最后5分钟1-0领先，你希望球队？', category:'战术风格', options:[
  ...
  { id:90, question:'你更欣赏哪种竞技哲学？', category:'战术风格', options:[
  ...
  { id:91, question:'你更喜欢哪种体育视觉设计？', category:'战术风格', options:[
    { text:'经典复古风——致敬黄金年代的质感', traits:[3,0,1,0,1,0] },
    { text:'极简现代风——干净利落的几何线条', traits:[1,0,0,2,0,2] },
    { text:'民族地域风——独特的在地文化符号', traits:[0,1,4,0,2,0] },
    { text:'大胆实验风——打破常规的前卫表达', traits:[0,3,0,0,2,3] }
  ]},
  { id:92, question:'你更喜欢哪种球队的战术标签？', category:'战术风格', options:[
  ...
  { id:93, question:'如果球队引进新援，你更看重？', category:'战术风格', options:[
    { text:'技术能力——传停带射的基本功', traits:[0,0,0,1,0,4] },
    { text:'身体素质——速度力量对抗', traits:[0,3,0,0,0,2] },
    { text:'战术适应性——能否融入体系', traits:[0,0,0,4,0,3] },
    { text:'精神属性——意志力和求胜欲', traits:[0,5,0,0,1,0] }
  ]},
  { id:94, question:'对你而言，战术素养的体现在哪里？', category:'战术风格', options:[
    { text:'无球跑动——创造空间的艺术', traits:[0,0,0,1,0,5] },
    { text:'换人时机——教练的临场智慧', traits:[1,0,0,2,0,3] },
    { text:'阵型弹性——攻守转换的流畅度', traits:[0,0,0,2,0,4] },
    { text:'执行力——全队步调一致完成计划', traits:[1,1,0,2,0,2] }
  ]},
  { id:95, question:'你更喜欢哪种球队领袖？', category:'战术风格', options:[
    { text:'精神领袖——用怒吼和行动感染全队', traits:[0,5,0,0,2,0] },
    { text:'战术指挥官——场上教练的角色', traits:[0,0,0,2,0,5] },
    { text:'安静的大师——用表现说话', traits:[2,0,0,0,0,2] },
    { text:'团队凝聚者——把所有人团结在一起', traits:[0,1,0,0,3,0] }
  ]},
  { id:96, question:'你看足球比赛最关注哪个环节？', category:'战术风格', options:[
  ...
  { id:97, question:'面对强队，你更欣赏哪种策略？', category:'战术风格', options:[
    { text:'以我为主，坚持自己的打法', traits:[1,3,0,0,0,4] },
    { text:'针对性布置，限制对手强点', traits:[1,0,0,2,0,3] },
    { text:'收缩防守，伺机反击', traits:[2,0,0,0,0,2] },
    { text:'全员拼搏，用意志弥补差距', traits:[0,5,0,0,1,1] }
  ]},
  { id:98, question:'你更喜欢哪种足球纪录片风格？（战术视角）', category:'战术风格', options:[
    { text:'深度战术复盘类——分析每一个回合', traits:[0,0,0,3,0,5] },
    { text:'球星成长传记类——讲述球员故事', traits:[0,3,0,1,2,0] },
    { text:'赛季回顾类——完整记录球队旅程', traits:[1,1,0,0,2,1] },
    { text:'数据分析类——用数字解读足球', traits:[0,0,0,4,0,3] }
  ]},
  { id:99, question:'一个完美的足球周末，最重要的是？', category:'战术风格', options:[
    { text:'主队赢球——结果决定一切', traits:[3,2,0,0,1,0] },
    { text:'比赛精彩——90分钟没有一刻无聊', traits:[0,2,0,0,2,4] },
    { text:'氛围超棒——和球迷一起的狂欢', traits:[0,1,0,0,5,0] },
    { text:'战术对弈——看到教练的智慧碰撞', traits:[0,0,0,2,0,5] }
  ]},
  { id:100, question:'最后一道题：足球教会你最重要的事？', category:'战术风格', options:[
    { text:'Never give up——绝杀之前一切皆有可能', traits:[0,5,0,0,2,0] },
    { text:'团队大于个人——没有谁可以一个人赢', traits:[0,1,1,0,1,4] },
    { text:'接受不完美——误判、失误也是足球的一部分', traits:[1,1,0,0,0,2] },
    { text:'享受当下——每一场都可能是最后一场', traits:[0,2,0,0,4,1] }
  ]},
];
...
const HOMETOWN_BONUS = 0.05; // 家乡匹配加权 5%
...
// 热门球队加权（余弦相似度叠加，让大众球队在得分接近时优先胜出）
const POPULARITY_BONUS = {
  real_madrid:0.10, barcelona:0.10, man_city:0.10, liverpool:0.10,
  arsenal:0.10, bayern:0.10, chelsea:0.07, man_utd:0.07,
  psg:0.07, dortmund:0.07, juventus:0.06, ac_milan:0.06,
  inter_milan:0.06, zhejiang:0.05, tottenham:0.05,
};
